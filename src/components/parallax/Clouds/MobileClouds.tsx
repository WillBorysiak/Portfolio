...
const MobileClouds = () => {
	return (
		<>
			...
			<FontAwesomeIcon icon={faPlaneProp} size="6x" className="absolute z-0 ml-56 mt-24 text-lightText opacity-50" />
			<FontAwesomeIcon icon={faClouds} size="5x" className="absolute z-0 ml-16 mt-[450px] text-lightText opacity-100" />
		</>
	);
};
