	...
	return (
		<>
			...
			<FontAwesomeIcon
				icon={faPlaneProp}
				size="6x"
				className="absolute left-2/3 top-40 z-0 text-lightText opacity-50"
			/>
			<FontAwesomeIcon icon={faClouds} size="5x" className="absolute top-2/4 left-52 z-0 text-lightText opacity-50" />
		</>
	);
};
