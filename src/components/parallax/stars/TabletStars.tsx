import { faPlanetMoon, faPlanetRinged } from '@fortawesome/pro-duotone-svg-icons';
...
const TabletStars = () => {
	return (
		<>
			...
			/>
			<FontAwesomeIcon icon={faPlanetMoon} size="6x" className="absolute z-0 ml-16 mt-[600px] text-light opacity-20" />
		</>
	);
};
