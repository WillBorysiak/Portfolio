...
const ContactInfo = () => {
  return (
    ...
    >
      <div className="text-dynamic-theme mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-extrabold sm:text-4xl">
            I&lsquo;m currently employed as software developer in the UK.
          </h2>
          <p className="mt-3 text-2xl sm:mt-4">
            ...
            <div className="mx-auto max-w-4xl">
              <dl className="rounded-lg bg-black/[.75] shadow-lg sm:grid sm:grid-cols-2 dark:bg-black/[.5]">
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  ...
                  <dd className="text-wide-light-transition dark:text-light-theme order-1 text-4xl font-extrabold">
                    CV
                  </dd>
                </div>
                <div className="text-dynamic-theme flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                  <dt className="text-light-theme order-2 mt-5 text-2xl leading-6 font-medium">
                    Links in the footer
                  </dt>
                  <dd className="text-wide-light-transition dark:text-light-theme order-1 text-4xl font-extrabold">
                    Socials
